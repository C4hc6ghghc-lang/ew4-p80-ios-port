# P40 Native Migration Matrix — unified mainline

P40 does **not** restart the game. It preserves the complete P39 single-player PORT_ONLY tree and integrates the already-written Swift/SpriteKit work under `SOURCE_NATIVE/EW4_iOS_NativePort`.
...
| BattleSave schema 6 / save presentation / compatibility | **P39 truth / pending native parity** | `battle_save_core.js`, P25/P26/P30 regressions |
| round settlement, food, healing, turn limits | **P39 truth / pending native parity** | `country_turn_core.js`, `native_training_core.js`, round/stage tests |
| result controller / five-grade awards / replay delta / victory text | **P39 truth / pending native parity** | `native_result_core.js`, P16/P30 result tests |
...
| Conquest selection, extinction matrix, failure/complete/challenge | **P39 truth / pending native parity** | `native_conquest_*`, P29/P30 tests |
