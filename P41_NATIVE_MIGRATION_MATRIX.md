# P41 Native Migration Matrix — unified mainline

P41 continues the recovered unified mainline and does **not** restart the game. It preserves the complete P39 single-player PORT_ONLY tree and integrates the already-written Swift/SpriteKit work under `SOURCE_NATIVE/EW4_iOS_NativePort`.
